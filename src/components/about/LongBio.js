...
export default function LongBio() {
    ...
    return (
        <>
            ...
            <p className="text">Currently I am learning Next.js and quite enjoying it!</p>
            <p className="text">By the end of the year I want to dig into PHP and build at least one working app.</p>
        </>
 )
}