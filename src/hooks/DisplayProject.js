...
const DisplayProject = React.memo(
  ({
    title,
    subtitle,
    src,
        ...
        <div className="collapsible-content">
          <div className="content-inner">
            ...
            {features.map((feature) => {
              return (
                <ul key={feature.id}>
                  <li key={feature.id} className="project-description">
                    {feature.text}
                  </li>
                </ul>
              );
              ...
              <div className="icons">
                <a href={github} rel="noopener noreferrer" target="_blank">
                  <svg viewBox="0 0 128 128" aria-labelledby={githubAriaLabels}>
                    <title id={githubAriaTitle} lang="en">
                      Github icon
                    </title>
              ...
              <div className="icons">
                <a href={url} rel="noopener noreferrer" target="_blank">
                  <svg
                    ...
                    fill="none"
                    viewBox="0 0 24 24"
                    aria-labelledby={desktopAriaLabels}
                  >
                    <title id={desktopAriaTitle} lang="en">
